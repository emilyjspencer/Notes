...
No hot-reloading. The server must be stopped and re-started after any changes
...
```
* It's good practice to make use of partials, so as to avoid repetition of code
* To make use of EJS partials, they have to be called in the files in which they are required.
